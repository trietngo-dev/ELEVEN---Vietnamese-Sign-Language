...
[ApiController]
[Route("api/lessons")]
public sealed class LessonsController(ILessonService service) : ControllerBase
{
    [HttpGet]
    ...
    [HttpPut("{id:long}")]
    public async Task<IActionResult> Update([FromRoute] long id, [FromBody] UpdateLessonRequest request, CancellationToken cancellationToken = default)
    {
